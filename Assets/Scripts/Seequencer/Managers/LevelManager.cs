...
namespace See
{
    ...
    public class LevelManager : Utility.Singleton<LevelManager>
    {
        /// <summary>
        ...
        /// </summary>
        [SerializeField]
        private LevelIndex _levelIndex = LevelIndex.Home;
        ...
        {
            StartCoroutine(LoadSceneDelay((int)_levelIndex));
        }
